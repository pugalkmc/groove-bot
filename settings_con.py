...
async def binance_option(update, context):
    ...
    if option_1 == text:
        ...
        await bot.send_photo(chat_id=chat_id, photo=open('binance_1.jpg', 'rb'))
        await bot.send_photo(chat_id=chat_id, photo=open('binance_2.jpg', 'rb'))
        return SET_BINANCE
    elif "settings" == text:
        await settings(update, context)
        return ConversationHandler.END
